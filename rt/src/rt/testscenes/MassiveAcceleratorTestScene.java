...
public class MassiveAcceleratorTestScene extends Scene {
	
	public MassiveAcceleratorTestScene()
	{
		// Output file name
		outputFilename = new String("../output/testscenes/MassiveAcceleratorTestScene");
		...
		Vector3f eye = new Vector3f(0.f, 0.f, 7.f);
		...
		Aggregate mesh = null;
		try {
			mesh = ObjReader.read("../obj/xyzrgb_statuette.obj", 3f);
		} catch (IOException e) {
			e.printStackTrace();
		}
		...
		t.setIdentity();
		t.setTranslation(new Vector3f(0,1.5f,0));
