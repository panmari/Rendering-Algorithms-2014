...
import rt.intersectables.CSG.CSGNode;
import rt.intersectables.CSG.CSGPlane;
import rt.intersectables.CSG.CSGSolid;
import rt.intersectables.CSG.CSGSphere;
import rt.intersectables.CSG.CSGUnitCylinder;
import rt.lightsources.*;
import rt.materials.*;
import rt.samplers.*;
import rt.tonemappers.ClampTonemapper;

public class ReflectiveTestScene extends Scene {
	
	public ReflectiveTestScene()
	{
		// Output file name
		outputFilename = new String("../output/testscenes/ReflectiveScene");
