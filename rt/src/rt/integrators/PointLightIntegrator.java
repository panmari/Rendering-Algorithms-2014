...
public class PointLightIntegrator implements Integrator {
	...
	public Spectrum integrate(Ray r) {
		...
		if(hitRecord != null)
		{
			...
			LightGeometry lightSource = lightList.getRandomLight( makePixelSamples(sampler, 2));
			...
			float prob = lightHit.p*1f/lightList.size();
			s.mult(1.f/(d2*prob));
			
			// Accumulate
			outgoing.add(s);
			outgoing = doFog(r, hitRecord, outgoing);
			return outgoing;
		} else 
